...
Route::add(['GET', 'POST'], '/select_numbers', [Controller\Site::class, 'select_numbers'])->middleware('auth');;
Route::add(['GET', 'POST'], '/select_all_numbers', [Controller\Site::class, 'select_all_numbers'])->middleware('auth');;
Route::add(['GET', 'POST'], '/count_abonents', [Controller\Site::class, 'count_abonents'])->middleware('auth');;



Route::add(['GET', 'POST'], '/subscriber', [Controller\Site::class, 'subscriber'])->middleware('auth');;
Route::add(['GET', 'POST'], '/phone', [Controller\Site::class, 'phone'])->middleware('auth');;
Route::add(['GET', 'POST'], '/room', [Controller\Site::class, 'room'])->middleware('auth');;
Route::add(['GET', 'POST'], '/division', [Controller\Site::class, 'division'])->middleware('auth');;
